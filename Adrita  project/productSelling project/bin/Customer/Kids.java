...
public class Kids 
{
 ...
 JFrame frame;
  ...
  public Kids (ClientAcc c){

    client = c;
    
    frame = new JFrame("Kids collection");
    ...
    ImageIcon icon3 = new ImageIcon("images/kT-shirt.jpg");
    ...
    ImageIcon icon4 = new ImageIcon("images/ksandal.jpg");
    ...
    ImageIcon icon6 = new ImageIcon("images/kpants.jpg");
    ...
    b6.setBounds(140,350,200,180);
      ...
      ImageIcon icon7 = new ImageIcon("images/kwatch.jpg");
