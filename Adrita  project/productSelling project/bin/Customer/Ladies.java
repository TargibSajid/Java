...
public class Ladies 
{
 ...
 JFrame frame;
  ...
  public Ladies(ClientAcc c){

    client = c;
    
    frame = new JFrame("Ladies collection");
    ...
    l2 = new JLabel("COLLECTION -> Ladies");
    ...
    ImageIcon icon3 = new ImageIcon("images/saree.jpg");
    ...
    ImageIcon icon4 = new ImageIcon("images/hijab.jpg");
    ...
    ImageIcon icon6 = new ImageIcon("images/Makeup kit.jpg");
    ...
    b6.setBounds(140,350,200,180);
      ...
      ImageIcon icon7 = new ImageIcon("images/wsandal.jpg");
